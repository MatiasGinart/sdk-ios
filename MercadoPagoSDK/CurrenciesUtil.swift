...
class CurrenciesUtil {
 
    class var currenciesList : [String: Currency] { return [
        ...
        "VEF" : Currency(id: "VEF", description: "Bolivar fuerte", symbol: "BsF", decimalPlaces: 2, decimalSeparator: ",", thousandSeparator: ".")
        ]}
 
    class func formatNumber(amount: Double, currencyId: String) -> String? {

...
public class AppDelegate: UIResponder, UIApplicationDelegate {
    static public let kifNotification = "AppDelegate_kifNotification"
...
#if DEBUG
        NSNotificationCenter.defaultCenter().addObserver(self, selector: Selector("kifStarts"), name: AppDelegate.kifNotification, object: nil)
#endif
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MercadoPagoSDKExamples", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("MercadoPagoSDKExamples.sqlite")

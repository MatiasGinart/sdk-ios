...
class FinalVaultViewController : AdvancedVaultViewController {
    ...
    var finalCallback : ((paymentMethod: PaymentMethod, token: Token?, cardIssuerId: Int?, installments: Int?) -> Void)?
    ...
    init(merchantPublicKey: String, merchantBaseUrl: String, merchantGetCustomerUri: String, merchantAccessToken: String, amount: Double, supportedPaymentTypes: [String], discount: Discount?, callback: (paymentMethod: PaymentMethod, token: Token?, cardIssuerId: Int?, installments: Int?) -> Void) {
